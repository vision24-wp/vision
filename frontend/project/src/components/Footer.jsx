...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-br from-[#020617] via-[#0f172a] to-[#020617] border-t border-white/10">
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#features" className="text-white/70 hover:text-primary-300 transition-colors text-sm">
                  Features
                </a>
              </li>
              <li>
                <a href="#about" className="text-white/70 hover:text-primary-300 transition-colors text-sm">
                  About Us
                </a>
              </li>
              <li>
                <a href="#" className="text-white/70 hover:text-primary-300 transition-colors text-sm">
                  Scholarships
                </a>
              </li>
              <li>
                <a href="#" className="text-white/70 hover:text-[#38bdf8] transition-colors text-sm">
                  Study Materials
                </a>
              </li>
            </ul>
